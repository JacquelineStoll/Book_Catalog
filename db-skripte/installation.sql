...
INSERT INTO author (forename, surname, date_of_birth)
		values('J. R. R.', 'Tolkien', '1892-01-03'), ('E. L.', 'James', '1963-03-07'), ('Stephen', 'King', '1947-09-21'), ('Frank', 'Herbert', '1920-10-08'), ('Charles', 'Dickens', '1812-02-07'), ('Antoine', 'de Saint-Exupéry', '1900-06-29'), ('Astrid', 'Lindgren', '1907-11-14'), ('Herman', 'Melville', '1819-08-01');
INSERT INTO genre (`name`)
		values('Horror'), ('Sci-Fi'), ('Fantasy'), ('Romantisch'), ('Historischer Roman'), ('Kinderbuch'), ('Abenteuer');
INSERT INTO publisher (description, LOCATION)
		values('Heyne Verlag', 'München'), ('Klett-Cotta Verlag', 'Stuttgard'), ('Goldmann Verlag', 'München'), ('Boer Verlag', 'München'), ('Anaconda Verlag', 'Köln'), ('Verlagsgruppe Oetinger', 'Hamburg');
