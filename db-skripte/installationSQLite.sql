ALTER TABLE book DROP CONSTRAINTEGER autor_id, DROP CONSTRAINTEGER verlag_id, DROP CONSTRAINTEGER genre_id;

ALTER TABLE lending DROP CONSTRAINTEGER user_id, DROP CONSTRAINTEGER book_id;
...
CREATE TABLE book (
    ...
    CONSTRAINT a_id FOREIGN KEY (a_id) REFERENCES autor(a_id),
    CONSTRAINT p_id FOREIGN KEY (p_id) REFERENCES publisher(p_id),
    CONSTRAINT g_id FOREIGN KEY (g_id) REFERENCES genre(g_id),
);
...
CREATE TABLE lending (
    ...
    CONSTRAINT b_id FOREIGN KEY (b_id) REFERENCES book(b_id)
);
...
INSERT INTO author (forename, surname, date_of_birth)
		values('J. R. R.', 'Tolkien', '1892-01-03'), ('E. L.', 'James', '1963-03-07'), ('Stephen', 'King', '1947-09-21'), ('Frank', 'Herbert', '1920-10-08'), ('Charles', 'Dickens', '1812-02-07'), ('Antoine', 'de SaINTEGER-Exupéry', '1900-06-29'), ('Astrid', 'Lindgren', '1907-11-14'), ('Herman', 'Melville', '1819-08-01'), ('Johann Wolfgang', 'von Goethe', '1832-03-22'), ('Georg', 'Büchner', '1813-08-17');
