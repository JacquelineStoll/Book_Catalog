...
ALTER TABLE lending DROP CONSTRAINT kunde_id, DROP CONSTRAINT book_id;
...
ALTER TABLE lending
	ADD CONSTRAINT kunde_id FOREIGN KEY (c_id) REFERENCES customer (c_id),
...
INSERT INTO customer (forename, surname, date_of_birth, street, house_number, postal_code, city)
		values('Finn', 'Schulz', '1999-08-20', 'Dortmunder Straße', '36', 48155, 'Münster'), ('Max', 'Mustermann', '1980-10-30', 'Musterweg', '17', 78976, 'Musterhausen');